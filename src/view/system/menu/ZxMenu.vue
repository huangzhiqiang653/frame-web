      ...
      <el-container class="tree-content">
        <el-row class="margin-top-20">
          <el-form
            ...
            <el-divider content-position="left">菜单信息{{formData.name?'('+formData.name+')':''}}
            </el-divider>
            <el-alert
              title="根节点数据不允许操作"
            ...
            <el-col :span="12">
              <el-form-item label="URL链接：" prop="url">
                <el-input v-model="formData.url" placeholder="URL链接" maxlength="64"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="图标：" prop="icon">
                <el-input v-model="formData.icon" placeholder="图标" maxlength="64"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
          ...
          <el-col :span="24">
            ...
            <el-button
              ...
              style="margin: 0 20px;"
              :size="GLOBAL.config.systemSize">增加子菜单
            </el-button>
            <el-button
              v-if="editableFlag"
              @click="handleDelete"
...
<script>
    // 替换成相应的模板
    import zxResource from './../resource/ZxResourceTableSimple'
    ...
    export default {
        ...
        methods: {
            ...
            handleNodeClick: function (target, node) {
                ...
                this.$refs.zxResource.init(node.data.id)
            },
                        ...
                        this.FUNCTIONS.systemFunction.interactiveData(
                            ...
                            resultData => {
                                ...
                                if (resultData) {
                                    ...
                                    _this.getTreeData()
                                    _this.$refs.zxResource.init(resultData.id)
                                } else {
            ...
            handleDelete: function () {
                if (this.formData.children && this.formData.children.length) {
                    this.$message.warning('请先删除子菜单数据')
                    return
                }
                let _this = this
                _this.$confirm('确认删除当前菜单数据？？', '提示', {
