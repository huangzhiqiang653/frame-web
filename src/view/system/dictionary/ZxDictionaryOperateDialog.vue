          ...
          <el-form-item label="类型：" prop="type">
            ...
            >
              ...
              <el-option :label="item.name" :value="item.code"
                         v-for="item in dictionary.type" :key="item.id"></el-option>
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        // 字典数据
        dictionary: {
          type: JSON.parse(unescape(localStorage.getItem(this.GLOBAL.config.dictionaryPre + this.GLOBAL.config.dictionary.type)))
        },
        editableFlag: true,
        loading: false,
        showTitle: '新增',
