<!--zx_frame_db.auth_zx_resource（资源表）-dialog-->
<template>
      ...
      <el-row class="margin-top-20">
        <el-col :span="24">
          <el-form-item label="资源名称：" prop="resourceName">
            <el-input v-model="formData.resourceName" placeholder="资源名称" maxlength="64"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item label="资源编码：" prop="resourceCode">
            <el-input v-model="formData.resourceCode" placeholder="资源编码" maxlength="64"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="24">
